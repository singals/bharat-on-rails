...
Debtor.create([{ name: 'John Doe', village: 'Foo', phone: '9876543210', is_active: true },
               { name: 'Jane Doe', village: 'Bar', phone: '9875564321', is_active: true }])

sale_one = Sale.create!(nature: 'CASH', village: 'Baz', phone: '8976543201', total_amount: 2955)
...
sale_two = Sale.create(nature: 'CREDIT', debtor_id: 1, village: 'Foo', phone: '9876543210', total_amount: 1180)
